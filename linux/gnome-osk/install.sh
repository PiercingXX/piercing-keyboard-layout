...
# layout name — there is no user-level override path. So this script
# extracts the system bundle, adds piercing.json, recompiles, and replaces
# the bundle (keeping a .orig backup). Needs sudo for the final copy.
#
